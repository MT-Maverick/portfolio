...
let svgObjects = document.getElementsByClassName("svgImg");
    ...
    svgFrame.item(2).style.width = "100%";
...
function change() {
    ...
    setTimeout(()=>{ morph(shape,19,39,false);},10000);
